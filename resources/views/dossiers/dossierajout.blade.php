...
<div class="card ml-4" style="width: 70rem;">
                            ...
                            <form method="POST" action="{{ route('dossierajoutupdate') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('post') }}
                                        ...
                                        <div class="row">
                                                ...
                                                <h2>Ajouter Dossier Patient</h2>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        Taille (en CM)
                                                        <input type="number" class="form-control" id="" name="taille">
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                                        profession
                                                        <input type="text" class="form-control" id="" name="profession" placeholder="profession">
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                                        Nombre de Grossesse Anterieure
                                                        <input type="number" class="form-control" id="" name="grossesseanterieure" placeholder="grossesseanterieure">
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                                        Date des Dernières Règles
                                                        <input type="date" class="form-control" id="" name="regles">
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                                        Avortements
                                                        <input type="text" class="form-control" id="" name="avortement" placeholder="avortement">
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                                        Nombre d'Enfant
                                                        <input type="number" class="form-control" id="" name="nbreEnfant" >
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                                        cesarienne
                                                        <input type="text" class="form-control" id="" name="cesarienne" >
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <input type="date" class="form-control" id="" name="dateAccouchement" placeholder="dateAccouchement">
                                                        </label>
                                                    </div>
