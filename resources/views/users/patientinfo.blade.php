                        ...
                        <div class="row">
                            <div class="col-lg-3" style=" border-right:1px solid black; margin-right:20px;">
                                <div class="text-center">
                                    <img src="{{URL::asset($users->image)}}" height="140" style="border-radius: 55px!important;" class="rounded-pill" alt="...">
                                </div>
                               <div class="text-center">
                               <h5 class="card-title text-center mt-4">Profil</h5>
                               {{ $users->prenom }}
                               {{ $users->nom }}
                               </br>
                               {{ $users->age }} ANS
                               ...
                               {{ $users->email }}
                               <a href="" class="btn btn-primary" style="background-color: #FF1493;">Modifier Profil</a>
                               <h5 class="card-title text-center mt-4">Adresse</h5>
                               @if(isset($users->adresse))
                               @foreach ($adresses as $adresse)
                                <p class="card-text text-center">{{ $users->adresse->quartier }},{{ $users->adresse->ville }},{{ $users->adresse->pays }}</p>
                                <a href="" class="btn btn-primary" style="background-color: #FF1493;">Modifier Adresse</a>
                                @endforeach
                                @else
                                <p class="card-text text-center">Aucune Adresse Enregistrée</p>
                                <a href="{{ route('adresseajout',['users' => $users->id]) }}" class="btn btn-primary" style="background-color: #FF1493;">Ajouter Adresse</a>
                                @endif
                               <h5 class="card-title text-center mt-4">Antécédent</h5>
                               @if(isset($users->antecedent))
                               @foreach ($antecedents as $antecedent)
                                <p class="card-text text-center">{{ $users->antecedent->nom }}</p>
                                <a href="" class="btn btn-primary" style="background-color: #FF1493;">Modifier Antecedent</a>
                                @endforeach
                                @else
                                <p class="card-text text-center">Aucun Antécédent Enregistré</p>
                                <a href="{{ route('antecedentajout',['users' => $users->id]) }}" class="btn btn-primary" style="background-color: #FF1493;">Ajouter Antécédent</a>
                                @endif
                            ...
                            <!-- </div> -->
                            <div class="col-lg-6">
                            <h2>Informations du Dossier Patient</h2>
                            <div class="mb-4"  style="margin-left:385px;">
                                     <a href="" class="btn btn-primary" style="background-color: #FF1493;">Modifier Dossier Patient</a>
                                </div>
                                @if(isset($users->patient))
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Taille
                                            <span class="d-block small opacity-50">{{ $users->patient->taille }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Profession
                                            <span class="d-block small opacity-50">{{ $users->patient->profession }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Nombre de Grossesse Antérieure
                                            <span class="d-block small opacity-50">{{ $users->patient->grossesseanterieure }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            ...
                                            <span class="d-block small opacity-50">{{ $users->patient->regles }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Avortements
                                            <span class="d-block small opacity-50">{{ $users->patient->avortement }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Nombre d'Enfant
                                            <span class="d-block small opacity-50">{{ $users->patient->nbreEnfant }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @foreach ($patients as $patient)
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Cesarienne Antérieure
                                            <span class="d-block small opacity-50">{{ $users->patient->cesarienne }}</span>
                                        </label>
                                </div>
                                @endforeach
                                ...
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Date Approximatif d'Accouchement
                                            <span class="d-block small opacity-50">{{ $users->patient->dateAccouchement }}</span>
                                        </label>
                                </div>
                                @endforeach
                                @else
                                <p class="card-text text-center">Aucune Dossier Enregistré</p>
                                <a href="{{ route('dossierajout',['users' => $users->id]) }}" class="btn btn-primary" style="background-color: #FF1493;">Créer Dossier</a>
                                @endif
