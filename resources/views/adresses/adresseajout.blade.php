...
<body id="page-top">
 ...
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <form method="POST" action="{{ route('adresseajoutupdate') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('post') }}
                                        ...
                                        <div class="row">
                                                ...
                                                <h2>Ajouter Adresse Patient</h2>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        Quartier
                                                        <input type="text" class="form-control" id="" name="quartier">
                                                        </label>
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
