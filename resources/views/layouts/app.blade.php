...
<head>
    ...
    <title>{{ config('app.name', 'Dharma') }}</title>
...
<!-- Vendor CSS Files -->
<link href="{{ asset('design/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
<link href="{{ asset('design/vendor/animate.css/animate.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('design/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
...
<header id="header" class="fixed-top">
  ...
  <!-- Vendor JS Files -->
  <script src="{{ asset('design/vendor/purecounter/purecounter.js') }}"></script>
