                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <a href="{{ route('patientliste') }}" class="btn btn-primary">Créer Patient</a>
                                <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Prénom
                                            <span class="d-block small opacity-50">Christelle</span>
                                        </label>
                                    </div>
                                    <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                    ...
                                    <div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Adresse
                                            <span class="d-block small opacity-50">Sacré Coeur </span>
                                        </label>
                                    </div><div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Ville
                                            <span class="d-block small opacity-50">Dakar</span>
                                        </label>
                                    </div><div class="mb-4">
                                        <label class="list-group-item py-3" for="listGroupCheckableRadios1">
                                            Pays
                                            <span class="d-block small opacity-50">Sénégal</span>
                                        </label>
                                    </div>